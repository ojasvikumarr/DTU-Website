...
export default function LoginForm() {
    ...
    const DeployerhandleSubmit = async (e) => {
        e.preventDefault();
        const data = { demail, dpassword };

        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_HOST}/api/logindeployer`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    return (
      ...
      />
        ...
        {!visible && <div className="max-w-md w-96  mx-auto rounded-none md:rounded-2xl p-4 md:p-8 mt-16 shadow-input bg-white dark:bg-black">
